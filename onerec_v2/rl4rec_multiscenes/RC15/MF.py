...
class GRUnetwork:
    def __init__(self, hidden_size,learning_rate,item_num,state_size):
        ...
        self.len_state=tf.placeholder(tf.float32, [None],name='len_state')
        ...
        self.states_hidden=tf.reduce_sum(self.input_emb,axis=1)/tf.expand_dims(self.len_state,axis=-1)
